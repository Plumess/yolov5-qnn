...
def run(
        ...
        source=ROOT / 'datasets/im_yolov5/val/images',  # file/dir/URL/glob/screen/0(webcam)
        data=ROOT / 'data/im.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / '../../../dataset/train_3nc0612/val/images', help='file/dir/URL/glob/screen/0(webcam)')
    parser.add_argument('--data', type=str, default=ROOT / 'data/im_conda.yaml', help='(optional) dataset.yaml path')
