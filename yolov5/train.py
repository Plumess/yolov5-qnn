...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=ROOT / 'models/decrease_output.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/im_conda.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='0730', help='save to project/name')
