...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/im.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='/home/seekychan/zl/qnn_workspace/qnn_428/last.pt', help='model.pt path(s)')
